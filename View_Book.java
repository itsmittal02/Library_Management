...
public class View_Book extends JFrame implements ActionListener{
	   JButton jb,jb1 ;
	   ...
	   JLabel header ,body;
 	   View_Book(String s){
		   super(s);
		   setLayout(null);
		     header = new JLabel(new ImageIcon("12.jpg"));
		     body = new JLabel(new ImageIcon("15.jpg"));
			  ...
			  dtm.addColumn("Bid");
			  dtm.addColumn("CallNo");
			  dtm.addColumn("Bname");
			  dtm.addColumn("Author");
			  dtm.addColumn("Publisher");
			  dtm.addColumn("Quantity");
			  dtm.addColumn("Issued");
			  dtm.addColumn("Added-date");
			  ...
			  try{
					  ...
					  while(rs.next()){
 			             dtm.addRow(new Object[]{rs.getInt(1),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),rs.getString(7),rs.getString(8)});
					  }
					  cn.close();
			}
			catch(Exception er){
